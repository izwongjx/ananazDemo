      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
        {items.map((item, index) => (
          <motion.div
            ...
            className="group flex flex-col bg-white rounded-[2rem] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-1 border border-divider"
          >
            {/* Card Top: Image Area */}
            ...
            <div className="flex flex-col flex-1 p-5 lg:p-8">
              <h3 className="font-display text-xl lg:text-2xl font-semibold text-dark mb-1 lg:mb-2 group-hover:text-[#C18C74] transition-colors duration-300 line-clamp-1 lg:line-clamp-none">
                {item.name}
              </h3>
              ...
              {/* Benefits Pills - Always visible now to make up for removed description */}
