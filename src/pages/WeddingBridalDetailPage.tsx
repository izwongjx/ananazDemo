...
export default function WeddingBridalDetailPage() {
  const { id } = useParams<{ id: string }>()
  const treatment = weddingBridalPackages.find(t => t.id === id)

  if (!treatment) return <Navigate to="/services/wedding-bridal" replace />

  const t = treatment
  const currentIndex = weddingBridalPackages.indexOf(t)
  const next = weddingBridalPackages[(currentIndex + 1) % weddingBridalPackages.length]
  ...
  return (
    <div className="bg-[#FAF9F6] min-h-screen">
      ...
      <section className="bg-white border-y border-divider py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <FadeUp className="mb-12">
            <p className="font-body text-[10px] tracking-[0.3em] uppercase text-gold font-bold mb-2">The Glow</p>
            <h2 className="font-display text-3xl font-semibold text-dark">Package Inclusions</h2>
          </FadeUp>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          <div>
            <FadeUp className="mb-20">
              <p className="font-body text-[11px] tracking-[0.3em] uppercase text-gold font-bold mb-4">The Timeline</p>
              <h2 className="font-display text-4xl font-semibold text-dark leading-tight">Preparation Journey</h2>
            </FadeUp>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16">
            <FadeUp>
              ...
              <h2 className="font-display text-4xl font-semibold text-dark mb-6">Bridal Care Guide</h2>
              <p className="font-body text-base text-muted leading-relaxed">
                Maintain your pre-wedding results with these essential care steps leading up to your big day.
              </p>
            </FadeUp>
      ...
      <section className="border-t border-divider grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-divider">
        <Link to={`/wedding-bridal/${prev.id}`}
