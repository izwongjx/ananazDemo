...
import { glassSkinTreatments as skinTreatments } from '../data/glassSkin'
...
export default function GlassSkinDetailPage() {
  const { id } = useParams<{ id: string }>()
  const treatment = skinTreatments.find(t => t.id === id)

  if (!treatment) return <Navigate to="/glass-skin" replace />
