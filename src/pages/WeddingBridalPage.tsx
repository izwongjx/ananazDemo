    ...
    <div className="bg-[#FAF9F6] min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 py-20">
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <div>
            <p className="font-body text-[10px] tracking-[0.3em] uppercase text-gold mb-2 font-bold">Our Bridal Packages</p>
            <h2 className="font-display text-3xl lg:text-4xl font-semibold text-dark">3 Tiers of Radiance</h2>
          </div>
          <p className="font-body text-xs text-muted hidden lg:block max-w-xs text-right leading-relaxed">
            Select a package to see the detailed inclusions and the timeline for your perfect bridal glow.
          </p>
        </motion.div>

        <div className="divide-y divide-divider">
          {weddingBridalPackages.map((t, i) => (
            <motion.div
              key={t.id}
