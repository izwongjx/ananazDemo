...
import { skinBrightTreatments as skinTreatments } from '../data/skinBright'
...
export default function SkinBrightDetailPage() {
  const { id } = useParams<{ id: string }>()
  const treatment = skinTreatments.find(t => t.id === id)

  if (!treatment) return <Navigate to="/skin-bright" replace />
