...
import { bodyWellnessTreatments as skinTreatments } from '../data/bodyWellness'
...
export default function BodyWellnessDetailPage() {
  const { id } = useParams<{ id: string }>()
  const treatment = skinTreatments.find(t => t.id === id)

  if (!treatment) return <Navigate to="/body-wellness" replace />
