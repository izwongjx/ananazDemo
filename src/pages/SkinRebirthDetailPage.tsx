...
import { skinRebirthTreatments as skinTreatments } from '../data/skinRebirth'
...
export default function SkinRebirthDetailPage() {
  const { id } = useParams<{ id: string }>()
  const treatment = skinTreatments.find(t => t.id === id)

  if (!treatment) return <Navigate to="/skin-rebirth" replace />
