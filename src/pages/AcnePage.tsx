...
import { acneTreatments } from '../data/acne'
  ...
  return (
    <div className="bg-cream min-h-screen pt-24">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 py-20 lg:py-28">
        <TreatmentGrid currentCategory="acne" items={acneTreatments} />
      </section>
